 ...
 */
final class Version20201217102045 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_43915DCCE750CD0E ON port (idpays)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE port CHANGE idpays idpays VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
