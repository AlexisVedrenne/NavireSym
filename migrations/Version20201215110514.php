 ...
 */
final class Version20201215110514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE aisshiptype ADD les_ports_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aisshiptype DROP les_ports_id');
    }
}
