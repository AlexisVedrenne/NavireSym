 ...
 */
final class Version20201217144931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE navire (id INT AUTO_INCREMENT NOT NULL, idpays INT NOT NULL, idportdestination INT DEFAULT NULL, imo VARCHAR(7) NOT NULL, nom VARCHAR(100) NOT NULL, mmsi VARCHAR(9) NOT NULL, indicatifappel VARCHAR(10) NOT NULL, eta DATETIME DEFAULT NULL, longueur INT NOT NULL, largeur INT NOT NULL, triantdeau NUMERIC(4, 1) NOT NULL, UNIQUE INDEX UNIQ_EED1038B519409E (imo), INDEX IDX_EED1038E750CD0E (idpays), INDEX IDX_EED1038427CFE1F (idportdestination), UNIQUE INDEX mmsi_unique (mmsi), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE navire_ais_ship_type (navire_id INT NOT NULL, ais_ship_type_id INT NOT NULL, INDEX IDX_8954FF47D840FD82 (navire_id), INDEX IDX_8954FF47479E0B84 (ais_ship_type_id), PRIMARY KEY(navire_id, ais_ship_type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE navire_ais_ship_type DROP FOREIGN KEY FK_8954FF47479E0B84');
        $this->addSql('ALTER TABLE porttypecompatible DROP FOREIGN KEY FK_2C02FFDB53BA86F9');
        $this->addSql('ALTER TABLE navire_ais_ship_type DROP FOREIGN KEY FK_8954FF47D840FD82');
