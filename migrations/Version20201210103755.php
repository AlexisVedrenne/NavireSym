 ...
 */
final class Version20201210103755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE navire ADD lepavillon VARCHAR(255) NOT NULL, DROP idpays');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE navire ADD idpays INT NOT NULL, DROP lepavillon');
